...
3. After **Microsoft Word** opens, a **Microsoft Azure Information Protection Sign-in** page appears. Enter **AlexW@M365xZZZZZZ.onmicrosoft** (where ZZZZZZ is your unique O365 Credentials) and then select **Next**.
...
10. In the **Microsoft Azure Information Protection** window that appears, select the following options:
	...
	- Select users, groups, or organizations: If Outlook is running, select the **address book** icon and then select **Joni Sherman** as the **To** address. If Outlook is not running, enter **JoniS@M365xZZZZZZ.onmicrosoft.com** (where ZZZZZZ is your unique O365 Credentials)
