...
10. Sign in as Admin@M365x**YYXXXXX.hostdomain.com**,
...
1. On LON-CL1, if required, sign in to Office365 admin center as Admin@M365xyyxxxxx.hostdomain.com.
...
19. On the Sign in page, at https://portal.office.com, sign in as abbi@M365xyyxxxxx.hostdomain.com.
...
6. If the **User Account Control** dialog box appears, type **Adatum\Admin** in the user name box, and then Select **Yes**.
...
11. In the top-right corner, if no one is signed in, sign in as **Beth@M365x****YYXXXXX****.hostdomain.com**, by Selecting the link **Sign in to get most out of office**.
...
17. On the **Sign in** page, and then Select **Sign in**.
