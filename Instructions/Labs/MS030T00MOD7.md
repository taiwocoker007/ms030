...
7. On the **Select your mail flow scenario** page, in the **From** box, select **Office 365 **.
...
7. Verify that the message sent to Diego is in quarantine, but the message sent to AlexW is not.
