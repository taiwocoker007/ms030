...
4. In the Microsoft 365  admin center, Select **Admin centers**, and then Select **SharePoint**.

5. On the leftmost side, Select **settings**.

6. Under **Site Collection Storage limits**, Select **Automatic**. select the **Classic settings page.**

7. Scroll down to **Enterprise Social Collaboration**.

8. Select **Use Yammer.com service**.

9. Select **OK**. go back to the **Sharepoint Admin** Tab in the Edge browser.

10. On the leftmost side, Select **sharing**.

11. Verify that **Allow Guest to share items they dont own and guest must sign in using the same account to which sharing invitations are sent.** is selected, and then Select **Save**.

## Task 2: Configure user profiles

1. On the leftmost side, Select **More features** then **user profiles**.

2. Under **people**, Select **Manage User Profiles**. 

3. In the **Find profiles** dialog box, type **PattiF**, and then Select **Find**.

4. In the result window, in the drop-down list, Select **PattiF**.
...
8. Back on the **Sharepoint Admin center** tab On the left side, Select **More features** then Select **user profiles**.
...
1. Back on the **Sharepoint Admin center** tab On the leftmost side,Select **More features** then Select **apps**, and then Select **Configure Store Settings**.
...
2. In the Microsoft 365  admin center, on the left side menu, Select **Admin centers**, and then Select **SharePoint**.

3. In the leftmost side, Select More Features then  Select **Classic site collections page**.

4. On the Classic site collections page ribbon, Select **New**, and then Select Private Site Collection.
...
4. In the Microsoft 365  admin center, Select **Admin**, and then Select **SharePoint**.

5. On the leftmost side, Select **Active Sites**.

6. Select the **https://M365xyyxxxxx.sharepoint.com/sites/marketing** check box.

7. On the ribbon, Select **owners**, and then Select **Mod Administrator**.

8. In the **Site Collection Administrators** text box, type **PattiF**, Select the **Check Names** icon, and then Select **OK**.

9. Open another InPrivate window, browse to **https://M365xyyxxxxx.sharepoint.com/sites/marketing**, and sign in as **PattiF@M365xyyxxxxx.hostdomain.com**,
...
12. Verify that **PattiF Russell** appears.
...
3. Sign in as **AllanD@M365xyyxxxxx.hostdomain.com**
...
16. In the text box at the top, type **Patti**, and then Select **Patti Fernandez**.
...
20. Sign in as **AllanD@M365xyyxxxxx.hostdomain.com**
...
24. Sign in as **PattiF@M365xyyxxxxx.hostdomain.com**
...
2. Select the **https://M365xyyxxxxx.sharepoint.com/sites/Marketing** check box.
...
8. Open Microsoft Edge and browse to **https://M365xyyxxxxx.sharepoint.com/sites/Marketing**.

9. Sign in as **Admin@M365xyyxxxxx.hostdomain.com**

10. In the top-right corner, Select **SHARE**.

11. In the **Share ‘Accounts Project’** dialog box, type in the email address of the Microsoft account you used to set up Microsoft 365 .
